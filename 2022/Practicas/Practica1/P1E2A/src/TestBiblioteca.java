...
public class TestBiblioteca {
    ...
    public void setUp() {
        ...
        s1 = new Socio("Arya Stark", "test@test.com", "5234-5");
    ...
    public void test() {
        ...
        //socio 1
        assertEquals(datos[0], s1.getNombre());
        assertEquals(datos[1], s1.getEmail());
        assertEquals(datos[2], s1.getLegajo());

        //socio 2
        assertEquals(datos[3], s2.getNombre());
        assertEquals(datos[4], s2.getEmail());
        assertEquals(datos[5], s2.getLegajo());
